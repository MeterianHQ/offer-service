...
public class GetterSetterVerifierTester<T> {
     ...
     */
    private GetterSetterVerifierTester(@Nonnull final Class<T> type) {
        this.type = type;
    }
     ...
     */
    public GetterSetterVerifierTester<T> include(@Nonnull final String include) {
        if (includes == null) {
     ...
     * @return This object, for method chaining.
     */
    public GetterSetterVerifierTester<T> exclude(@Nonnull final String exclude) {
        if (excludes == null) {
