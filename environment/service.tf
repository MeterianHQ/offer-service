...
module "offer_service" {
  ...
  offer_service_host_port = "${var.offer_service_port}"
  ...
  offer_management_ui_host_port = "${var.offer_managment_iu_port}"

  alb_target_group_offer_management_ui_id = "${module.offer_service_alb.alb_target_group_offer_management_ui_id}"
  alb_target_group_offer_service_id = "${module.offer_service_alb.alb_target_group_offer_service_id}"
